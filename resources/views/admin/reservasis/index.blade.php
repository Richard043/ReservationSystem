...
<body>
    ...
    <div class="content">
        <div class="card">
            <h1 class="text-center mb-4">Manage Reservasis</h1>
            <a href="{{ route('admin.reservasis.create') }}" class="btn btn-primary mb-3">Add New Reservasi</a>
            @if(session('success'))
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.reservasis.show', $reservasi->id) }}" class="btn btn-info btn-sm">View</a>
                            <a href="{{ route('admin.reservasis.edit', $reservasi->id) }}" class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ route('admin.reservasis.destroy', $reservasi->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
